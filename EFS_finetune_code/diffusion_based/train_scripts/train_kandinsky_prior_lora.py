...
def main():
    ...
    class ImageTextDataset(torch.utils.data.Dataset):
        ...
        def __init__(self, image_folder, tokenizer, image_processor, args):
        ...
        def __getitem__(self, idx):
            ...
            clip_pixel_values = image_processor(image, return_tensors="pt").pixel_values
            ...
            tokenized = self.tokenizer(prompt, padding='max_length', max_length=self.tokenizer.model_max_length, truncation=True, return_tensors='pt')
    ...
    with accelerator.main_process_first():
        train_dataset = ImageTextDataset(args.image_folder, tokenizer, image_processor, args)
    ...
    def collate_fn(examples):
        ...
        return {"clip_pixel_values": clip_pixel_values[:, 0], "text_input_ids": text_input_ids, "text_mask": text_mask}
            ...
            if accelerator.sync_gradients:
                ...
                if global_step % args.checkpointing_steps == 0:
                    if accelerator.is_main_process:
                        ...
                        prior_lora_state_dict = get_peft_model_state_dict(unwrapped_prior)
