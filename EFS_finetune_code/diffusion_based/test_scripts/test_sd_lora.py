...
# for seed in range(25):
    ...
    # )
    image = pipeline(prompt, negative_prompt=negative_prompt, num_inference_steps=20,
                    num_images_per_prompt=1, guidance_scale=7.5, height=args.resolution, width=args.resolution, generator=generator).images[0]
