...
def main():
    ...
    class ImageTextDataset(torch.utils.data.Dataset):
        ...
        def __init__(self, image_folder, image_processor, transforms, args):
    ...
    with accelerator.main_process_first():
        train_dataset = ImageTextDataset(args.image_folder, image_processor, train_transforms, args)
    ...
    def collate_fn(examples):
        ...
        clip_pixel_values = torch.cat([example["clip_pixel_values"] for example in examples])

        return {"pixel_values": image, "clip_pixel_values": clip_pixel_values}
